...
No mesmo arquivo você deve por seu usuário e senha do sqldeveloper no localhost, após isso é necessário rodar esse .bat.Copie e cole o texto do arquivo SQL no 
sqldeveloper e rode.Após isso é necessário dar node index.js no cmd